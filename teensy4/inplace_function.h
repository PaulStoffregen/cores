...
namespace stdext
{
    ...
    namespace inplace_function_detail
    {
        ...
        struct vtable
        {
            ...
            template <class C>
            explicit constexpr vtable(wrapper<C>) noexcept : invoke_ptr{[](storage_ptr_t storage_ptr, Args&&... args) -> R { return (*static_cast<C*>(storage_ptr))(
    ...
    class inplace_function<R(Args...), Capacity, Alignment>
    {
     ...
     public:
        ...
        template <
            ...
            class   = std::enable_if_t<
                !inplace_function_detail::is_inplace_function<C>::value && inplace_function_detail::is_invocable_r<R, C&, Args...>::value>>
            ...
            : inplace_function(other.vtable_ptr_, other.vtable_ptr_->copy_ptr, std::addressof(other.storage_))
        {
            static_assert(inplace_function_detail::is_valid_inplace_dst<
                              Capacity, Alignment, Cap, Align>::value,
        ...
        inplace_function(inplace_function&& other) noexcept : vtable_ptr_{std::exchange(other.vtable_ptr_, std::addressof(inplace_function_detail::empty_vtable<R, Args...>))}
        {
     ...
     private:
        ...
        inplace_function(
            ...
            typename vtable_t::storage_ptr_t storage_ptr) : vtable_ptr_{vtable_ptr}
        {

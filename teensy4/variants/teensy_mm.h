...
#define PINS_TO_PWM_INFO {                          \
  ...
  {1, M(1, 2), 1, 1}, /* 38 FLEXPWM1_PWMA02      */ \
  {1, M(1, 2), 2, 1}, /* 39 FLEXPWM1_PWMB02      */ \
  {2, M(2, 1), 0, 1}, /* 40 QTIMER2_TIMER1       */ \
  {2, M(2, 2), 0, 1}, /* 41 QTIMER2_TIMER2       */ \
  {0, M(1, 0), 0, 0}, /* 42 dupe FLEXPWM2_PWMA00 */ \

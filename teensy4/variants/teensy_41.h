...
#define CORE_ADC14_PIN 38
#define CORE_ADC15_PIN 39
#define CORE_ADC16_PIN 40
#define CORE_ADC17_PIN 41
...
#define CORE_NUM_SERIAL_INSTANCES 8
...
#define SERIAL1_RX_ALT_PIN            52                             
#define SERIAL1_RX_ALT_MUX_VAL        2                              
#define SERIAL1_RX_ALT_INPUT_REGISTER &IOMUXC_LPUART6_RX_SELECT_INPUT
...
#define SERIAL1_TX_ALT_PIN            53                             
#define SERIAL1_TX_ALT_MUX_VAL        2                              
#define SERIAL1_TX_ALT_INPUT_REGISTER &IOMUXC_LPUART6_TX_SELECT_INPUT
...
#define SERIAL8_IRQ                   IRQ_LPUART5                    
#define SERIAL8_CCM_REGISTER          CCM_CCGR3                      
#define SERIAL8_CCM_VALUE             CCM_CCGR3_LPUART5(CCM_CCGR_ON) 
#define SERIAL8_RX_PIN                34                             
#define SERIAL8_RX_MUX_VAL            1                              
#define SERIAL8_RX_INPUT_REGISTER     &IOMUXC_LPUART5_RX_SELECT_INPUT
#define SERIAL8_RX_INPUT_VALUE        1                              
#define SERIAL8_RX_ALT_PIN            48                             
#define SERIAL8_RX_ALT_MUX_VAL        2                              
#define SERIAL8_RX_ALT_INPUT_REGISTER &IOMUXC_LPUART5_RX_SELECT_INPUT
#define SERIAL8_RX_ALT_INPUT_VALUE    0                              
#define SERIAL8_TX_PIN                35                             
#define SERIAL8_TX_MUX_VAL            1                              
#define SERIAL8_TX_INPUT_REGISTER     &IOMUXC_LPUART5_TX_SELECT_INPUT
#define SERIAL8_TX_INPUT_VALUE        1                              
#define SERIAL8_TX_ALT_PIN            0xff                           
#define SERIAL8_TX_ALT_MUX_VAL        0xff                           
#define SERIAL8_TX_ALT_INPUT_REGISTER nullptr                        
#define SERIAL8_TX_ALT_INPUT_VALUE    0                              
#define SERIAL8_TX_DMAMUX_SOURCE      DMAMUX_SOURCE_LPUART5_TX       
#define SERIAL8_CTS_PIN               50                             
#define SERIAL8_CTS_MUX_VAL           2                              
#define SERIAL8_RTS_LOW_WATERMARK     38                             
#define SERIAL8_RTS_HIGH_WATERMARK    24                             
#define SERIAL8_XBAR_TRIGGER          XBARA1_OUT_LPUART5_TRG_INPUT   
...
#define PINS_TO_ANALOG_CHANNELS {         \
  ...
  255,   /* 36 -         GPIO_B1_02    */ \
  255,   /* 37 -         GPIO_B1_03    */ \
  128+1, /* 38 ADC2_IN1  GPIO_AD_B1_12 */ \
  128+2, /* 39 ADC2_IN2  GPIO_AD_B1_13 */ \
  9,     /* 40 ADC1_IN9  GPIO_AD_B1_04 */ \
  10,    /* 41 ADC1_IN10 GPIO_AD_B1_05 */ \
}
...
#define PINS_TO_PWM_INFO {                          \
  ...
  {0, M(1, 0), 0, 0}, /* 34 -                    */ \
  {0, M(1, 0), 0, 0}, /* 35 -                    */ \
  {1, M(2, 3), 1, 6}, /* 36 FLEXPWM2_PWMA03      */ \
  {1, M(2, 3), 2, 6}, /* 37 FLEXPWM2_PWMB03      */ \
  {0, M(1, 0), 0, 0}, /* 38 -                    */ \
  {0, M(1, 0), 0, 0}, /* 39 -                    */ \
  {0, M(1, 0), 0, 0}, /* 40 -                    */ \
  {0, M(1, 0), 0, 0}, /* 41 -                    */ \
  {1, M(1, 1), 2, 1}, /* 42 FLEXPWM1_PWMB01      */ \
  {1, M(1, 1), 1, 1}, /* 43 FLEXPWM1_PWMA01      */ \
  {1, M(1, 0), 2, 1}, /* 44 FLEXPWM1_PWMB00      */ \
  {1, M(1, 0), 1, 1}, /* 45 FLEXPWM1_PWMA00      */ \
  {1, M(1, 2), 2, 1}, /* 46 FLEXPWM1_PWMB02      */ \
  {1, M(1, 2), 1, 1}, /* 47 FLEXPWM1_PWMA02      */ \
  {0, M(1, 0), 0, 0}, /* 48 dupe FLEXPWM1_PWMB00 */ \
  {0, M(1, 0), 0, 0}, /* 49 dupe FLEXPWM1_PWMA02 */ \
  {0, M(1, 0), 0, 0}, /* 50 dupe FLEXPWM1_PWMB02 */ \
  {1, M(3, 3), 2, 1}, /* 51 FLEXPWM3_PWMB03      */ \
  {0, M(1, 0), 0, 0}, /* 52 dupe FLEXPWM1_PWMB01 */ \
  {0, M(1, 0), 0, 0}, /* 53 dupe FLEXPWM1_PWMA01 */ \
  {1, M(3, 0), 1, 1}, /* 54 FLEXPWM3_PWMA00      */ \
}

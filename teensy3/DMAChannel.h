...
public:
	...
	void source(volatile signed char &p) { source(*(volatile uint8_t *)&p); }
	void source(volatile unsigned char &p) {
		TCD->SADDR = &p;
		TCD->SOFF = 0;
		TCD->ATTR_SRC = 0;
	...
	void source(volatile signed short &p) { source(*(volatile uint16_t *)&p); }
	void source(volatile unsigned short &p) {
		TCD->SADDR = &p;
		TCD->SOFF = 0;
		TCD->ATTR_SRC = 1;
	...
	void source(volatile signed int &p) { source(*(volatile uint32_t *)&p); }
	void source(volatile unsigned int &p) { source(*(volatile uint32_t *)&p); }
	void source(volatile signed long &p) { source(*(volatile uint32_t *)&p); }
	void source(volatile unsigned long &p) {
		TCD->SADDR = &p;
		TCD->SOFF = 0;
		TCD->ATTR_SRC = 2;
	...
	void sourceBuffer(volatile signed char p[], unsigned int len) {
		sourceBuffer((uint8_t *)p, len); }
	void sourceBuffer(volatile unsigned char p[], unsigned int len) {
		TCD->SADDR = p;
		TCD->SOFF = 1;
		TCD->ATTR_SRC = 0;
		TCD->NBYTES = 1;
	...
	void sourceBuffer(volatile signed short p[], unsigned int len) {
		sourceBuffer((uint16_t *)p, len); }
	void sourceBuffer(volatile unsigned short p[], unsigned int len) {
		TCD->SADDR = p;
		TCD->SOFF = 2;
		TCD->ATTR_SRC = 1;
		TCD->NBYTES = 2;
	...
	void sourceBuffer(volatile signed int p[], unsigned int len) {
		sourceBuffer((uint32_t *)p, len); }
	void sourceBuffer(volatile unsigned int p[], unsigned int len) {
		sourceBuffer((uint32_t *)p, len); } 
	void sourceBuffer(volatile signed long p[], unsigned int len) {
		sourceBuffer((uint32_t *)p, len); }
	void sourceBuffer(volatile unsigned long p[], unsigned int len) {
		TCD->SADDR = p;
		TCD->SOFF = 4;
		TCD->ATTR_SRC = 2;
		TCD->NBYTES = 4;
	...
	void sourceCircular(volatile signed char p[], unsigned int len) {
		sourceCircular((uint8_t *)p, len); }
	void sourceCircular(volatile unsigned char p[], unsigned int len) {
		TCD->SADDR = p;
		TCD->SOFF = 1;
	...
	void sourceCircular(volatile signed short p[], unsigned int len) {
		sourceCircular((uint16_t *)p, len); }
	void sourceCircular(volatile unsigned short p[], unsigned int len) {
		TCD->SADDR = p;
		TCD->SOFF = 2;
	...
	void sourceCircular(volatile signed int p[], unsigned int len) {
		sourceCircular((uint32_t *)p, len); }
	void sourceCircular(volatile unsigned int p[], unsigned int len) {
		sourceCircular((uint32_t *)p, len); }
	void sourceCircular(volatile signed long p[], unsigned int len) {
		sourceCircular((uint32_t *)p, len); }
	void sourceCircular(volatile unsigned long p[], unsigned int len) {
		TCD->SADDR = p;
		TCD->SOFF = 4;
